...
```
 ...
 add this to your qb-core items.lua
 ```
...
step 4 add images to your inventory 

step 5 tell bostra he is handsome again

step 6 take the bostra_metaldetecor folder and place it in your scripts folder
